...
def check_security(dll,path = os.environ['WINDIR']):
	...
	with open(filename+'.csv', 'wb') as csvfile:
		...
		filewriter.writerow([ 'binName' , filename ])
		filewriter.writerow([ 'ASLR' ,  str(dll.OPTIONAL_HEADER.IMAGE_DLLCHARACTERISTICS_DYNAMIC_BASE) ])
		filewriter.writerow([ 'DEP' ,  str(dll.OPTIONAL_HEADER.IMAGE_DLLCHARACTERISTICS_NX_COMPAT) ])
		filewriter.writerow([ 'SafeSEH' ,  str(dll.OPTIONAL_HEADER.IMAGE_DLLCHARACTERISTICS_NO_SEH) ])
		filewriter.writerow([ 'ControlFlowGuard' ,  str(dll.OPTIONAL_HEADER.IMAGE_DLLCHARACTERISTICS_GUARD_CF) ])
		filewriter.writerow([ 'HighentropyVA' ,  str(dll.OPTIONAL_HEADER.IMAGE_DLLCHARACTERISTICS_HIGH_ENTROPY_VA) ])
